...
import com.yibi.backend.config.WxOpenConfig;
...
import com.yibi.backend.model.dto.user.*;
...
public class UserController {
     ...
     * 根据 id 获取用户（仅管理员）
     *
     * @param sendVeriRequest
     * @param request
     * @return
     */
    @GetMapping("/sendCode")
    public BaseResponse<String> sendVerifyCode(SendVeriRequest sendVeriRequest, HttpServletRequest request) {
/*        String regex = "^[A-Za-z0-9+_.-]+@(.+)$";
        ...
        String userEmail = sendVeriRequest.getUserEmail();
