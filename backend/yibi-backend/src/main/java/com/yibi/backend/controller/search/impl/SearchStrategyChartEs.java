...
@Component
public class SearchStrategyChartEs implements SearchStrategy {
    private static SearchStrategyChartEs searchStrategyChartEs;
    ...
    public void init() {
        searchStrategyChartEs = this;
        searchStrategyChartEs.chartService = this.chartService;
    ...
    public Page<ChartVO> doSearch(CommonQueryRequest commonQueryRequest, HttpServletRequest request) {
        ...
        Page<Chart> chartPage = searchStrategyChartEs.chartService.searchFromEs(chartQueryRequest);
        Page<ChartVO> chartVOPage = searchStrategyChartEs.chartService.getChartVOPage(chartPage, request);
        return chartVOPage;
    }
}
